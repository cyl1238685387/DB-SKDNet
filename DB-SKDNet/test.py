...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='./test_result/C2F-SemiCD/WHU/WHU5%-KD4-Student/') #半监督C2F-SemiCD影像保存路径！！！
    ...
    if opt.data_name == 'LEVIR':
        opt.test_root = '/home/zhaobin/CDDataset/LEVIR/test/'
        ...
        opt.test_root = '/home/zhaobin/CDDataset/WHU/test/'
        ...
        opt.test_root = '/home/zhaobin/CDDataset/SYSU/test/'
...
#-------测试老师的模型teacher-------
    ...
    #-------测试学生的模型student-------
    save_path = './output/C2F-SemiCD/WHU5%-KD4/'  #半监督C2F-SemiCD模型路径！！
    # save_path = './output/C2FNet/WHU/'  #全监督C2FNet模型路径！！
